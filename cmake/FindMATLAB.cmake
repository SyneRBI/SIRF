...
# recommended way to use this is to set MATLAB_ROOT first.
# Otherwise, it will go and try to find it, but that's hard...
# Defines:
...
#  SET_TARGET_PROPERTIES(yourmexfile PROPERTIES
#        SUFFIX ".${MATLAB_MEX_EXT}" PREFIX "${MATLAB_PREFIX}"
#        LINK_FLAGS "${MATLAB_CXXLINKER_FLAGS}") 
#  target_link_libraries(mstir other_libraries ${MATLAB_LIBRARIES} )
#
...
# Copyright 2014, 2017 University College London
...
if (NOT MATLAB_ROOT)
  ...
  if (MATLAB_EXE_PATH)
    ...
    message(STATUS "MATLAB executable after resolving symbolic links: ${MATLAB_EXE_PATH}")

...
stir_lib15 =...
    [stir_libpath...
    'analytic\FBP2D\Release\analytic_FBP2D.lib'];
stir_lib16 =...
    [stir_libpath...
    'analytic\FBP3DRP\Release\analytic_FBP3DRP.lib'];
...
mex('-largeArrayDims',...
    boost_ipath, stir_ipath, cstir_ipath, util_ipath,...
    'mstir.c', 'printer.cpp',...
    ...
    stir_lib11, stir_lib12, stir_lib13, stir_lib14, stir_lib15, stir_lib16);

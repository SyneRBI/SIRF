...
try:
    ...
    # create filter
    filter_type = stir.TruncateToCylindricalFOVImageProcessor()
    print 'filter ok'

    # create objective function
    obj_fun =\
        stir.PoissonLogLikelihoodWithLinearModelForMeanAndProjData3DFloat()
    ...
    recon.set_inter_iteration_filter_type(filter_type)
...
##        pylab.show()
    ...
    expectedImage = stir.Image3DFloat()

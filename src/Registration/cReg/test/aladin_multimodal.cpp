...
\brief Test for Registration_Nifty_aladin (affine registration with NiftyReg)
...
int aladin_multimodal(string output_path)
{
        ...
        string parameter_file_f3d       = examples_path + "/paramFiles/aladin.par";
        string warped_image_filename    = output_path   + "/aladin_multimodal_CPLUSPLUS";

...
EXPORTED_FUNCTION void* mSIRF_axpbyAlt(const PTR_FLOAT ptr_a, const void* ptr_x, const PTR_FLOAT ptr_b, const void* ptr_y, void* ptr_z) {
	return cSIRF_axpbyAlt(ptr_a, ptr_x, ptr_b, ptr_y, ptr_z);
}
...
EXPORTED_FUNCTION void* mSIRF_product(const void* ptr_x, const void* ptr_y) {
	return cSIRF_product(ptr_x, ptr_y);
}
...
EXPORTED_FUNCTION void* mSIRF_ratio(const void* ptr_x, const void* ptr_y) {
	return cSIRF_ratio(ptr_x, ptr_y);
}

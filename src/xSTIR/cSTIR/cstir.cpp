...
extern "C"
void* cSTIR_computeACF(const void* ptr_sino, const void* ptr_mumap, void* ptr_att, void* ptr_acf, void* ptr_iacf)
{
	try {
		SPTR_FROM_HANDLE(STIRAcquisitionData, sptr_sino, ptr_sino);
		...
		PETAttenuationModel::compute_ac_factors(sptr_sino, sptr_mumap, sptr_att, sptr_acf, sptr_iacf);

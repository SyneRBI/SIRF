...
public:
	...
	void set_projectors(sirf::shared_ptr<ProjectorByBinPair> sptr_projectors)
	{
		sptr_projectors_ = sptr_projectors;
	}
	sirf::shared_ptr<ProjectorByBinPair> projectors_sptr()
	{
		return sptr_projectors_;
	}
	void set_additive_term(sirf::shared_ptr<PETAcquisitionData> sptr)
	{
		sptr_add_ = sptr;
	}
	sirf::shared_ptr<PETAcquisitionData> additive_term_sptr()
	{
		return sptr_add_;
	}
	void set_background_term(sirf::shared_ptr<PETAcquisitionData> sptr)
	{
		sptr_background_ = sptr;
	}
	sirf::shared_ptr<PETAcquisitionData> background_term_sptr()
	{
		return sptr_background_;
	}
	void set_normalisation(sirf::shared_ptr<BinNormalisation> sptr)
	{
		sptr_normalisation_ = sptr;
	}
	sirf::shared_ptr<BinNormalisation> normalisation_sptr()
	{
		return sptr_normalisation_;
	}
	void set_bin_efficiency(sirf::shared_ptr<PETAcquisitionData> sptr_data);
	void set_normalisation(sirf::shared_ptr<PETAcquisitionData> sptr_data)
	{
		sirf::shared_ptr<ProjData> sptr(new ProjDataInMemory(*sptr_data));
	...
	virtual Succeeded set_up(
		sirf::shared_ptr<PETAcquisitionData> sptr_acq,
		sirf::shared_ptr<Image3DF> sptr_image);

	sirf::shared_ptr<PETAcquisitionData>
		forward(const Image3DF& image);

	sirf::shared_ptr<Image3DF> backward(ProjData& ad);

protected:
	sirf::shared_ptr<ProjectorByBinPair> sptr_projectors_;
	sirf::shared_ptr<PETAcquisitionData> sptr_acq_template_;
	sirf::shared_ptr<Image3DF> sptr_image_template_;
	sirf::shared_ptr<PETAcquisitionData> sptr_add_;
	sirf::shared_ptr<PETAcquisitionData> sptr_background_;
	sirf::shared_ptr<BinNormalisation> sptr_normalisation_;
	sirf::shared_ptr<PETAcquisitionData> sptr_norm_;
};
...
public:
	...
	void set_acquisition_model(sirf::shared_ptr<AcqMod3DF> sptr)
	{
		sptr_am_ = sptr;
		AcqMod3DF& am = *sptr;
	...
	sirf::shared_ptr<AcqMod3DF> acquisition_model_sptr()
	{
		return sptr_am_;
	}
private:
	sirf::shared_ptr<AcqMod3DF> sptr_am_;
};

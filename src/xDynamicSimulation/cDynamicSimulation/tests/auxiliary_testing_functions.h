...
namespace aux_test
{
	...
	sirf::CoilSensitivitiesVector get_mock_gaussian_csm( std::vector<size_t> vol_dims, int const num_coils );
	...
	std::vector<ExternalTissueSignal> get_mock_external_signal(const std::vector<LabelType>& label_list);

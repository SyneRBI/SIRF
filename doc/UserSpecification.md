...
“nodes”. Input will be a Study object, parameters can be set via a
text file (suggested to be in YAML https://en.wikipedia.org/wiki/YAML),
a parameter file supported by the underlying reconstruction engine, or
inline.

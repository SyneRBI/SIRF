...
* SIRF/STIR
  ...
  - PET/Registration `ImageData` and PET `AcquisitionData` have `.asarray(copy=None)` (NumPy-like behaviour: zero-copy if `copy==False`, fallback to deepcopy otherwise) via `__array_interface__`.

...
def main():
    ...
    ad_aux = acq_data * acq_data
    s = ad_aux.norm()
    print(s)
    ad_aux = acq_data.sapyb(0.0, acq_data, acq_data)
    s = ad_aux.norm()
    print(s)
    ad_aux = acq_data.sapyb(acq_data, acq_data, 0.0)
    s = ad_aux.norm()
    print(s)
    acq_data.sapyb(0.0, acq_data, acq_data, out=ad_aux)
    s = ad_aux.norm()
    print(s)
    acq_data.sapyb(acq_data, acq_data, 0.0, out=ad_aux)
    s = ad_aux.norm()
    print(s)
    s = acq_data.norm()
    ...
    s = im_aux.norm()
    print(s)
    im_aux = image.sapyb(0.0, image, image)
    s = im_aux.norm()
    print(s)
    im_aux = image.sapyb(image, image, 0.0)
    s = im_aux.norm()
    print(s)
    image.sapyb(0.0, image, image, out=im_aux)
    s = im_aux.norm()
    print(s)
    image.sapyb(image, image, 0.0, out=im_aux)
    s = im_aux.norm()
    print(s)

                 ...
                 const DiscretisedDensity<3,elemT> &current_image_estimate)
{
  ...
  for (int z=min_z; z<=max_z; z++) 
	...
	cerr << "Prior gradient max " << prior_gradient.find_max()
		<< ", min " << prior_gradient.find_min() << endl;
                        ...
                        const DiscretisedDensity<3,elemT> &current_image_estimate)
{
  ...
  for (int z=min_z; z<=max_z; z++)  
	...
	cerr << " parabolic_surrogate_curvature max " << parabolic_surrogate_curvature.find_max()
		<< ", min " << parabolic_surrogate_curvature.find_min() << endl;
	/*{
    static int count = 0;
    ++count;
    char filename[20];
